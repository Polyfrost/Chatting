...
public class PlayerFaceRendererMixin implements HeadHook {
    @Shadow
    private static void /*? if >= 26.1 {*/ /*extractHat *//*?} else {*/ drawHat /*?}*/ (/*? if >= 26.1 {*/ /*GuiGraphicsExtractor *//*?} else {*/ GuiGraphics /*?}*/ graphics, /*? if >= 1.21.11 {*/ /*Identifier *//*?} else {*/ ResourceLocation /*?}*/ texture, int x, int y, int size, boolean upsideDown /*? if >= 1.21.4 {*/ /*, int color *//*?}*/) {
